...
public class SupervisionImage {
    ...
    public SupervisionImage(Long sid, String stransactionnum, String simagetype, String sproofname, String soriginalname, String simagename, Short simagesn, String sstorepath, Date suploadtime) {
        this.sid = sid;

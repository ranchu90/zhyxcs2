...
public class SupervisionBusinessStatistics {
    private Long sid;
    ...
    public SupervisionBusinessStatistics(Long sid, String stransactionnum, String spbcode, String sbankareacode, String sbankcitycode, String sbankkind, String sbanktypecode, String sbusinesscategory, String saccounttype, String spass, String sovertime, String serrortype, Date shappentimes) {
        this.sid = sid;
    ...
    public SupervisionBusinessStatistics() {
        super();
    }
